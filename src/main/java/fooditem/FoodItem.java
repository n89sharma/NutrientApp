...
public class FoodItem {
    ...
    public static FoodItem of(FoodName foodName, List<NutrientAmount> nutrientAmounts) {
        FoodItem foodItem = new FoodItem();
        foodItem.setFoodId(foodName.getFoodId());
        foodItem.setFoodDescription(foodName.getFoodDescription());
